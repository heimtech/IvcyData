...
var Intense = (function() {
    ...
    function createViewer( title, caption, title_style, caption_style ) {
      ...
      if ( title ) {
		...
		captionTitle.className = 'ssth_vce_intense_images_title';
		if( title_style )
			captionTitle.setAttribute('style', title_style);
      ...
      if ( caption ) {
        ...
        captionText.className = 'ssth_vce_intense_images_title';
		if( caption_style )
			captionText.setAttribute('style', caption_style);
    ...
    function init( element ) {
      ...
      var title_style = element.getAttribute( 'data-title-style');
      var caption_style = element.getAttribute( 'data-caption-style');
      ...
      img.onload = function() {
        ...
        target = this;
        createViewer( title, caption, title_style, caption_style );
        lockBody();
        bindEvents();
        loop();
      }
